  ...
  return (
    <ContentWrapper gap="lg">
      <ModalUpper>
        ...
        <CardSection gap="md">
          <RowBetween>
            <TYPE.white color="white">Your AIDI Breakdown</TYPE.white>
        ...
        <CardSection gap="sm">
          <AutoColumn gap="md">
            <RowBetween>
              <TYPE.white color="white">1 Billion AIDI price:</TYPE.white>
              <TYPE.white color="white">${uniPrice?.toFixed(2) ?? '-'}</TYPE.white>
            </RowBetween>
            {/* <RowBetween>
              <TYPE.white color="white">AIDI in circulation:</TYPE.white>
            ...
            {uni && uni.chainId === ChainId.MAINNET ? (
              <ExternalLink href={`https://v2.info.uniswap.org/token/${uni.address}`}>View AIDI Analytics</ExternalLink>
            ) : null}
          </AutoColumn>
        </CardSection>
      </ModalUpper>
